...
const styles = StyleSheet.create({
  ...
  obraCapa: { width: 150, height: 200, objectFit: "contain", borderRadius: 4 },
  obraInfo: { flex: 1 },
  ...
  livroCard: { width: 120 },
  livroCapa: { width: 120, height: 160, objectFit: "contain", borderRadius: 4, marginBottom: 6, backgroundColor: "#EEE" },
