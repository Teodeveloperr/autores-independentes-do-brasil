...
// alguns segundos com deslizamento horizontal (todas as páginas ficam lado a lado numa
// faixa, que desliza via transform) — mesmo padrão de autoplay já usado no BlogCarousel/
// HomeBannerCarousel: não pausa no hover, só reinicia a contagem quando o índice muda
// (autoplay ou clique manual).
        ...
        >
          {paginas.map((pagina, i) => (
            <div
              ...
              style={{ display: "grid", gridTemplateColumns: "repeat(6, 1fr)", gap: "24px", flex: `0 0 ${100 / total}%`, minWidth: 0 }}
            >
              {pagina.map((a) => (
