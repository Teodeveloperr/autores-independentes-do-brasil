...
export default function LoginPage() {
  return (
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", background: "#002776" }}>
      ...
      <section className="responsive-flex-row section-pad-lg" style={{ background: "#002776", color: "white", padding: "60px 40px", flex: 1, display: "flex", alignItems: "center", gap: "40px" }}>
        <div style={{ flex: 1 }}>
