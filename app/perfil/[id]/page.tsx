        ...
        <div className="responsive-flex-row" style={{ display: "flex", gap: "32px", marginBottom: "40px", maxWidth: "1280px", marginLeft: "auto", marginRight: "auto" }}>
          ...
          <div style={{ flex: 1 }}>
            <div className="responsive-flex-row" style={{ display: "flex", gap: "24px", alignItems: "stretch", marginBottom: "40px" }}>
              ...
              {author.videoUrl ? (
                <video controls playsInline src={author.videoUrl} style={{ width: "400px", height: "100%", minHeight: "200px", objectFit: "cover", borderRadius: "8px", flexShrink: 0 }} />
              ) : isOwner ? (
                <div style={{ width: "400px", flexShrink: 0, minHeight: "200px", display: "flex", flexDirection: "column", justifyContent: "center", textAlign: "center", background: "#F6F6F6", borderRadius: "8px", padding: "16px 12px" }}>
